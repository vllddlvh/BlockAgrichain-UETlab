...
('b0000000-0000-0000-0000-000000000001', 'SYSTEM_ADMIN', 'Quản trị viên Hệ thống', 'Quyền cao nhất'),
('b0000000-0000-0000-0000-000000000002', 'ORG_ADMIN', 'Quản đốc / Giám đốc', 'Quản lý tổ chức'),
('b0000000-0000-0000-0000-000000000003', 'WAREHOUSE_STAFF', 'Nhân viên Kho', 'Thao tác trực tiếp lô hàng');
...
('c0000000-0000-0000-0000-000000000002', 'Nhà máy Rang xay Highlands', '0x2222222222222222222222222222222222222222', 'FACTORY', 'VERIFIED'),
('c0000000-0000-0000-0000-000000000003', 'Chuỗi Cửa Hàng The Coffee House', '0x3333333333333333333333333333333333333333', 'RETAILER', 'VERIFIED');
...
('d0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000002', 'quandoc@highlands.com', crypt('Admin@123', gen_salt('bf', 10)), 'Trần Quản Đốc'),
('d0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000003', 'kho@thecoffeehouse.com', crypt('Admin@123', gen_salt('bf', 10)), 'Nhân viên Siêu Thị');

-- Map Users vào Roles
INSERT INTO user_roles (user_id, role_id) VALUES 
('d0000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000001'),
...
INSERT INTO batches (id, batch_code, product_id, creator_org_id, current_owner_org_id, product_type, status, initial_quantity, current_quantity, unit_id, created_at) VALUES 
('22222222-0000-0000-0000-000000000002', 'FACTORY-RAW-01', '11111111-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000002', 'RAW_MATERIAL', 'DEPLETED', 2000.00, 0.00, 'f0000000-0000-0000-0000-000000000001', CURRENT_TIMESTAMP - INTERVAL '20 days');
...
(gen_random_uuid(), '22222222-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 'STORED_AND_VERIFIED', '{"note":"Nhà máy đã nhận hàng"}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '18 days'),
(gen_random_uuid(), '22222222-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 'MERGED', '{"used_quantity": 2000.00, "child_batch":"HL-ROASTED-B1"}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '15 days');


-- LÔ 3: Nhà máy chế biến ra 500 Hộp CF -> Bán 100 hộp cho Siêu thị -> Còn 400 hộp
INSERT INTO batches (id, batch_code, product_id, creator_org_id, current_owner_org_id, product_type, status, initial_quantity, current_quantity, unit_id, created_at) VALUES 
('22222222-0000-0000-0000-000000000003', 'HL-ROASTED-B1', '11111111-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'PROCESSED_FOOD', 'READY_FOR_SALE', 500.00, 400.00, 'f0000000-0000-0000-0000-000000000002', CURRENT_TIMESTAMP - INTERVAL '15 days');
...
INSERT INTO batch_events (id, batch_id, actor_user_id, event_type, metadata, created_by, created_at) VALUES 
(gen_random_uuid(), '22222222-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 'CREATED_FROM_MERGE', '{"note":"Đóng gói hoàn tất"}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '15 days'),
(gen_random_uuid(), '22222222-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 'PROCESSING', '{"action":"Kiểm tra ISO 9001: Đạt"}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '10 days'),
(gen_random_uuid(), '22222222-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 'SPLIT', '{"total_split_quantity": 100.00}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '5 days');


-- LÔ 4: 100 Hộp CF đã nằm tại quầy Siêu thị The Coffee House
INSERT INTO batches (id, batch_code, product_id, creator_org_id, current_owner_org_id, product_type, status, initial_quantity, current_quantity, unit_id, created_at) VALUES 
('22222222-0000-0000-0000-000000000004', 'TCH-ROASTED-RETAIL', '11111111-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000003', 'PROCESSED_FOOD', 'READY_FOR_SALE', 100.00, 100.00, 'f0000000-0000-0000-0000-000000000002', CURRENT_TIMESTAMP - INTERVAL '5 days');

INSERT INTO batch_lineage (parent_batch_id, child_batch_id, action_type, quantity, created_at) VALUES 
('22222222-0000-0000-0000-000000000003', '22222222-0000-0000-0000-000000000004', 'SPLIT', 100.00, CURRENT_TIMESTAMP - INTERVAL '5 days');

INSERT INTO batch_events (id, batch_id, actor_user_id, event_type, metadata, created_by, created_at) VALUES 
(gen_random_uuid(), '22222222-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000003', 'CREATED_FROM_SPLIT', '{"parent":"HL-ROASTED-B1"}', 'quandoc@highlands.com', CURRENT_TIMESTAMP - INTERVAL '5 days'),
(gen_random_uuid(), '22222222-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000004', 'STORED_AND_VERIFIED', '{"note":"Đã lên kệ siêu thị TCH"}', 'kho@thecoffeehouse.com', CURRENT_TIMESTAMP - INTERVAL '2 days');